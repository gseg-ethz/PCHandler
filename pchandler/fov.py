...
from typing import Self, cast  # cast is used to indicate to the type-checker that a np.ndarray 0D array was correctly cast to a scalar
...
class FoV:
    ...
    def __init__(self, *, horizontal_min: float, elevation_min: float, horizontal_max: float, elevation_max: float,
        ...
        values = np.array([horizontal_min, elevation_min, horizontal_max, elevation_max])
