...
class ScalarFieldManager(MutableMapping[str, ScalarField]):
    ...
    @property
    def rgb(self) -> NDArray[np.generic] | None:
        return self.get('rgb', None)

    @property
    def intensity(self) -> NDArray[np.generic] | None:
        return self.get('intensity', None)

    @property
    def normals(self) -> NDArray[np.generic] | None:
        return self.get('normals', None)

    @property
    def reflectance(self) -> NDArray[np.generic] | None:
        return self.get('reflectance', None)
