...
from typing import Final, NoReturn, overload, Literal
...
__all__: Final[list[str]] = [
    'data_io', 'geometry', 'filters', 'scalar_fields', 'base_types', 'constants', '__author__',
    '__email__', 'PointCloudData', '__version__', 'version', '__version_tuple__', 'version_tuple'
]
...
@overload
def __getattr__(name: Literal["data_io", "geometry", "filters", "scalar_fields", "base_types", "constants"]) -> ModuleType: ...
